...
public class PokemonAgua extends CartaPokemon {
    public static final CartaPokemon.Elementos FRAQUEZA = CartaPokemon.Elementos.PLANTA;
    public static final CartaPokemon.Elementos FORCA = CartaPokemon.Elementos.FOGO;

    public PokemonAgua (String nomePokemon, String nomeAtaque, Carta.Raridade raridade, int hp, int dano, int energiasPAtaque) {
    ...
    public boolean atacar (CartaPokemon outro) {
        ...
        final int BONUS_ATAQUE = outro instanceof PokemonFogo? CartaPokemon.BONUS_ATAQUE_DEFESA : 1;
        final int BONUS_DEFESA = outro instanceof PokemonPlanta? CartaPokemon.BONUS_ATAQUE_DEFESA : 1;
